...
import { Sparkles, FileText, Image, Wand2 } from "lucide-react";
...
const LoadingScreen = ({ isVisible, progress, currentStep }: LoadingScreenProps) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`flex items-center gap-3 p-3 rounded-lg transition-colors ${
                      ...
                      isComplete ? "bg-secondary/50" : "bg-transparent"
                    }`}
                  >
