...
const FeatureCard = ({
    ...
    const baseClasses = `relative bg-card rounded-2xl p-8 card-shadow flex items-start gap-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl ${comingSoon ? "opacity-90 cursor-not-allowed" : "cursor-pointer"} ${className}`
